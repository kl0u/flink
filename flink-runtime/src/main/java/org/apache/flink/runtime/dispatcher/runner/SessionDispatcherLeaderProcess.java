 ...
 * {@link Dispatcher}.
 */
public class SessionDispatcherLeaderProcess extends ApplicationDispatcherLeaderProcess {
	...
	private SessionDispatcherLeaderProcess(
		...
		super(leaderSessionId, dispatcherGatewayServiceFactory, jobGraphStore, ioExecutor, fatalErrorHandler, ApplicationHandler.NO_SUBMISSION);
	}
