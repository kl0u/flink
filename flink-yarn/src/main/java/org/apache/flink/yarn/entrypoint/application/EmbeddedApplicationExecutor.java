...
public class EmbeddedApplicationExecutor extends AbstractSessionClusterExecutor<String, EmbeddedClusterClientFactory> {
	...
	public EmbeddedApplicationExecutor(final CompletableFuture<LeaderGatewayRetriever<DispatcherGateway>> dispatcherGatewayRetrieverFuture) {
		super(new EmbeddedClusterClientFactory(dispatcherGatewayRetrieverFuture));
	}
}
