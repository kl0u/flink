...
/** Javadoc. */
@Internal
public class RocksSavepointStrategy<K> extends AbstractSnapshotStrategy<KeyedStateHandle>
    ...
    private RunnableFuture<SnapshotResult<KeyedStateHandle>> doSnapshot(
            CheckpointStreamFactory primaryStreamFactory) throws Exception {
        ...
        final SnapshotAsynchronousPartCallable asyncSnapshotCallable =
                new SnapshotAsynchronousPartCallable(
                        resources, checkpointStreamSupplier, primaryStreamFactory.toString());
        ...
        private void writeKVStateMetaData(final DataOutputView outputView) throws IOException {
            KeyedBackendSerializationProxy<K> serializationProxy =
                    new KeyedBackendSerializationProxy<>(
                            ...
                            // future
                            keySerializer,
                            resources.getMetadataSnapshots(),
                            !Objects.equals(
