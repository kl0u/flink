...
public class RocksResources {
	...
	public RocksStateWriter getStateWriter() throws IOException {
		return new RocksStateWriter(getSnapshot(), keyGroupPrefixBytes, this::getKVStateIterators);
	}
	...
	private Snapshot getSnapshot() throws IOException {
		if (snapshot == null) {
