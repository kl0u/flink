...
if [ $STAGE == "$STAGE_COMPILE" ]; then
	MVN="mvn clean install -nsu -Dflink.forkCount=2 -Dflink.forkCountTestPackage=2 -Dmaven.javadoc.skip=true -B -DskipTests $PROFILE -Dcheckstyle.skip=true -pl flink-connectors/flink-connector-kafka-0.11 -am"
	$MVN
	EXIT_CODE=$?
