...
public class MultiInputTransformationTranslator<OUT> extends SimpleTransformationTranslator<OUT, AbstractMultipleInputTransformation<OUT>> {
	...
	@Override
	protected Collection<Integer> translateForBatchInternal(AbstractMultipleInputTransformation<OUT> transformation, Context context) {
		return translateInternal(transformation, context);
	}

	@Override
	protected Collection<Integer> translateForStreamingInternal(AbstractMultipleInputTransformation<OUT> transformation, Context context) {
		return translateInternal(transformation, context);
	}
