 ...
 */
@Internal
public class MultipleInputTransformationTranslator<OUT> implements Translator<OUT, MultipleInputTransformation<OUT>> {

	@Override
	public Collection<Integer> translate(
			final MultipleInputTransformation<OUT> transformation,
