 ...
 * Javadoc.
 */
public class MultiInputProcessorImpl<OUT> implements InputProcessor {

	private static final Logger LOG = LoggerFactory.getLogger(MultiInputProcessorImpl.class);
	...
	private final MultiInputStreamOperator<OUT> streamOperator;
	...
	public MultiInputProcessorImpl(
			final Map<InputTag, InputConfig> configs,
			final MultiInputStreamTask<OUT> checkpointedTask,
			...
			final MultiInputStreamOperator<OUT> streamOperator,
